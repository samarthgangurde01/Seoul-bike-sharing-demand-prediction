...
def eda():
	...
	df = pd.read_csv("https://raw.githubusercontent.com/samarthgangurde01/seoul-bike-sharing-demand-prediction/main/cleaned%20data/Data.csv", sep=',', encoding='latin')
	dt = pd.read_csv("https://raw.githubusercontent.com/samarthgangurde01/seoul-bike-sharing-demand-prediction/main/cleaned%20data/File.csv", sep=',', encoding='latin')
	...
	if choice == "Descriptive":
		...
		img = Image.open("info1641661138.jpeg")
		st.image(img)
